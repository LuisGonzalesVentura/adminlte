    ...
    <table id="tablaConsultores" class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo 'informacion_voluntario/' . $voluntario->id_voluntario ?>" class="btn btn-success" type="button"><i class="ri-file-info-line"></i></a>
                </td>
                <td>
                    <a href="<?php echo 'documentos_voluntarios/' . $voluntario->id_voluntario ?>" class="btn btn-success" type="button"><i class="ri-folder-unknow-fill"></i></i></a>
                </td>
                <td>
                    <a href="<?php echo 'ver_contrato_voluntarios/' . $voluntario->id_voluntario ?>" class="btn btn-primary" type="button"><i class="ri-article-fill"></i></a>
                </td>
                <td>
                    <a href="<?php echo 'formulario_editar_voluntario/' . $voluntario->id_voluntario ?>" class="btn btn-success" type="button"><i class="ri-pencil-line"></i></a>
                </td>
            </tr>
            <?php $contador++; ?>
            <?php endforeach; ?>
