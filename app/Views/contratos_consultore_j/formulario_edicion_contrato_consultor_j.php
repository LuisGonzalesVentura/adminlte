...
<form id="editarForm" action="<?= base_url('contrato_consultor_jj/editarContratoConsultoria/' . $contrato_consultor->idcontrato_c_j) ?>" method="post" enctype="multipart/form-data">
    <div class="card">
        <div class="card-body">
            <div class="form-group">
                <label for="fecha_de_inicio">Fecha inicio contrato</label>
                <input type="date" class="form-control" name="fecha_de_inicio" value="<?= $contrato_consultor->fecha_inicio_contrato_c_j ?>" required>
            </div>

            <div class="form-group">
                <label for="fecha_de_finalizacion">Fecha finalización contrato</label>
                <input type="date" class="form-control" name="fecha_de_finalizacion" value="<?= $contrato_consultor->fecha_finalizacion_contrato_c_j ?>">
            </div>
