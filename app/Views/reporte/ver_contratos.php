                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php foreach ($contratos as $contrato): ?>
                                            <tr>
                                            <td>
    <a href="<?= base_url('pdfscontratos/' . $contrato['archivo_c']) ?>" target="_blank"><?= $contrato['archivo_c'] ?></a>

</td>
<td>
    <?= $contrato['tipo_contrato'] ?? 'Unknown Tipo Contrato'; ?>
</td>
...
<td><?= $contrato['fecha_finalizacion_contrato_c'] ?></td>
                            ...
                            <?php else: ?>
                                <p>No hay contratos asociados a este reporte.</p>
                            <?php endif; ?>
        </tbody>
    </table>
