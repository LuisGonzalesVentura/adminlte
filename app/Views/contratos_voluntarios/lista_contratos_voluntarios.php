...
<tbody>
    <!-- Iterar sobre los contratos de voluntarios -->
    <?php foreach ($contratos_voluntarios as $contrato_voluntario) : ?>
        <tr>
        <td><?= $contrato_voluntario->ci_voluntario ?></td> <!-- Mostrar el CI del voluntario -->
        <td><?= $contrato_voluntario->nombre_voluntario ?></td> <!-- Mostrar el nombre completo del voluntario -->
            <td>
                <a href="<?= base_url('pdfscontratos/' . $contrato_voluntario->archivo_v) ?>" target="_blank">
                    Abrir Archivo
                </a>
            </td>
            ...
            <td>
                ...
                $tipoContrato = $tipoContratoModel->find($contrato_voluntario->tipo_contrato_voluntario);
            ...
            <td><?= $contrato_voluntario->fecha_inicio_contrato_voluntario ?></td> <!-- Mostrar la fecha de inicio del contrato -->
            <td><?= $contrato_voluntario->fecha_finalizacion_contrato_voluntario ?></td> <!-- Mostrar la fecha de finalización del contrato -->
            <td>
                <!-- Enlace para editar el contrato de voluntario -->
                <a href="<?= base_url('contratos_voluntarios/vista_formulario_edicion_contrato_voluntario/' . $contrato_voluntario->id_c_v) ?>" class="btn btn-success" type="button">Editar contrato</a>
            </td>
        </tr>
    <?php endforeach; ?>
</tbody>
