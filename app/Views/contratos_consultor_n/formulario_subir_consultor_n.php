        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                    <form action="<?= base_url('contrato_consultor_nn/crearContratoConsultoria') ?>" method='post' enctype="multipart/form-data" id="formulario_contrato">
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select class="form-control" id="id_consultor" name="id_consultor">
                    ...
                    <?php foreach ($empleados_consultoria as $consultor): ?>
                        <option value="<?= $consultor->consultoria_id_n ?>"><?= $consultor->	carnet_identidad_n ?></option>
...
<script type="text/javascript">
    ...
    $("#crear_contratos_consultoria_n").addClass("active");
</script>
<script type="text/javascript">
